...
# Params
CHKPOINT_PTH = './pretrained_weights/simclr-shhs-final1.pth'
SAVE_PATH = "tuh-supervised.pth"
WEIGHT_DECAY = 1e-4
BATCH_SIZE = 128
lr = 5e-4
n_epochs = 200
...
PRETEXT_FILE = os.listdir(os.path.join(PATH, "train_shhs"))
PRETEXT_FILE.sort(key=natural_keys)
PRETEXT_FILE = [os.path.join(PATH, "train_shhs", f) for f in PRETEXT_FILE]
