...
# Params
SAVE_PATH = "mulEEG-total-shhs-final1.pth"
WEIGHT_DECAY = 1e-4
BATCH_SIZE = 128
lr = 5e-4
n_epochs = 200
...
class pretext_data(Dataset):
    ...
    def __getitem__(self, index):
        ...
        pos_len = len(pos) # 7
        pos = torch.tensor(pos[pos_len // 2]*1000) # (2, 3000)
        
        # augment

        anc,pos = augment(pos,config)
...
wb = wandb.init(
        project="delete",
        notes="mulEEG augmentations and single channels data is deleted",
        save_code=True,
