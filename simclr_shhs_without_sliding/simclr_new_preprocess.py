...
# Params
SAVE_PATH = "single-epoch-same-shhs-without-sliding.pth"
WEIGHT_DECAY = 1e-4
BATCH_SIZE = 128
lr = 5e-4
n_epochs = 200
...
pretext_loader = DataLoader(pretext_ds, batch_size=BATCH_SIZE, shuffle=True, num_workers=NUM_WORKERS)
...
wb = wandb.init(
        ...
        name="simclr-mulEEG-epochs-shhs with interpolation without sliding, T=1",
    )
